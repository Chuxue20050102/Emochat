# EmoChat 治愈系> **💡 提示：** .md文件，可以vscode快捷键Ctrl + Shift + V查看

# 🎨 UI 视觉设计与动效规范
 (Glassmorphism + Aurora)

各位前端同学要注意了！我们摒弃了“素色鹅卵石”这套基础枯燥的方案，给这套 APP 直接上了当前最前沿的**“现代毛玻璃 (Glassmorphism)”** 与 **“极光渐变色彩投影 (Aurora Gradients)”**，视觉冲击力极高。

## 一、 核心底色配置 (不准出现纯黑、纯白刺眼的高反差)
所有页面的底层背景色全部基于以下体系，严禁出现高反差原色（如 #FF0000）。
